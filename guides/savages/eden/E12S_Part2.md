...
<em>Let's consider for this example that the orb of light will first move to the West then rotate in a clockwise manner.</em>
...
{% include slideshow.html imgLink="singApo1.jpg;singApo2.jpg" imgDesc="" slideNumber=slideCounter %}
...
{% include slideshow.html imgLink="singApo4.jpg;singApo5.jpg;singApo6.jpg" imgDesc="Move to dodge the first explosion;<stron>Shell Crusher</strong> cast begins;Regroup middle for <stron>Shell Crusher</strong>" slideNumber=slideCounter %}
...
<em>Let's consider for this example that the debuffs will resolve in this order **Aero III/Blizzard III => Eruptions => Flares/Shadoweyes/Unholy Darkness**.</em>  
...
/!\ When you get in position for the last set of debuff(s) everyone has to look away from the middle of the arena based on their spread position to be sure to avoid the Shadoweye. 
...
*<u>Let's consider for this example that the orbs of light will move to the East and West then rotate in a clockwise manner.</u>*
...
*For the following positions, use the white lines on the ground to help you.*
