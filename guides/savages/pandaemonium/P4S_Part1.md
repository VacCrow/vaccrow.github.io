...
+ **<ins>Bloodrake</ins>:**
*Hesperos* will tether to three tiles of the stage and/or four players, either Tanks/Healers or DPS, dealing high <span class="magic">magical damage</span> to tethered players and sucking thier aether.  
...
When a player pops an orb, he will gain a <span class="speDebuff">Thrice-come Ruin</span> stack, transforming into a <span class="speDebuff">Doom</span> debuff at 3 stacks.
...
+ If the third tile is **(Lightning)**, move to the edge where *Hesperos* is jumping to:  
	+ if **(Fire)** is fourth, form two light groups, left and right of the boss while facing the middle.  
