...
The resolve order is:
  + **Kothornos Kick**.
  + **Kothornos Quakes** and **Thunder III** 4 towers on East or West side.
  + **Water IV**.
  + **Kothornos Kick** and **Thunder III** 4 towers on West or East, the one who didn't explode first.
  + **Kothornos Quakes**.
...
The resolve order is:
  ...
  + **Thunder III** towers will resolve sequentially in a clockwise manner starting from a cardinal.
...
Example with first **Fire IV** tethers on East/West:
{% assign slideCounter = 0 %}
{% include slideshow.html imgLink="act1-1.jpg;act1-2.jpg;act1-3.jpg" imgDesc="Move to North/South;Soak <strong>Thunder III</strong> towers;Move to East/West" slideNumber=slideCounter %}

Once **Act 1** is completed, the boss will cast **Nearsight** or **Farsight**:

+ **Nearsight**, the Tanks move North inside the boss' hitbox and the rest of the group move out of it, behind him.
+ **Farsight**, the Tanks move North outside the boss' hitbox and the rest of the group move inside, behind him.

</div>

<div class='guideSection' markdown='1'>
<a id='SAkanthaiAct2'></a>
...
Then the boss will cast **Wreath Of Thorns** into **Dark Design**. During **Dark Design** cast, everyone must be under the boss to bait the AoEs and the Tank and Healer with **Dark IV** tethers must bait on North East and South West.  
