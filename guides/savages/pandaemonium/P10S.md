...
+ **<u>Harrowing Hell</u>:**
8 consecutive raid-wide AoE dealing high <span class='phys'>physical damage</span> (~45k). The two closest player from the boss take increased damage (~120k). All the hits are spread over 15 seconds and the last is a massive knockback.
